...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   hWnd_1 = CreateWindowW(szWindowClass, szTitle, WS_OVERLAPPEDWINDOW,
      CW_USEDEFAULT, 0, CW_USEDEFAULT, 0, nullptr, nullptr, hInstance, nullptr);

   hWnd_2 = CreateWindowW(szWindowClass, szTitle, WS_OVERLAPPEDWINDOW,
